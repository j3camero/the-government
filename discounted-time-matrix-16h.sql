SELECT
  ...
  SUM(EXP(0.000000267417893734547 * TIMESTAMPDIFF(SECOND, NOW(), tt.t)) * tt.diluted_seconds) AS discounted_diluted_seconds
...
ORDER BY SUM(EXP(0.000000267417893734547 * TIMESTAMPDIFF(SECOND, NOW(), tt.t)) * tt.diluted_seconds)
;
